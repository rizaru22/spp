								...
								<div class="panel-body">
									...
									<table class="table table-striped table-bordered" id="example">
										...
										<tbody id="tampil">
											...
											$kelas=$_GET['id'];
											$sql=mysqli_query($koneksi,"select ts.nis,ts.nama,ts.jk,ts.id_kelas,tk.id,tk.nama as nama_kelas,tk.wali_kelas from tbl_siswa as ts inner join tbl_kelas as tk where ts.id_kelas=tk.id AND ts.id_kelas=$kelas order by nama asc");
											$no=1;
